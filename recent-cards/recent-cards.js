...
// if (recentCards <= [0]) 
// {
//     document.getElementById(#message)createText('You have no recent readings. Please navigate back to home.');
...
// // //if (recentCards.length === null) {
// // console.log('You have no recent readings');
// document.createTextNode('You have no recent readings. Please navigate back to home.');
